...
def parse_args():
    ...
    parser.add_argument('--opt', type=str, help='path to option file', default="options/test_rrdb_P+SeD.yml")
    parser.add_argument('--output_path', type=str, help='path to your output', default="output/")
