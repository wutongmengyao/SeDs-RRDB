...
from models import model_rrdb, sed
...
def parse_args():
    ...
    parser.add_argument('--opt', type=str, help='path to option file', default="options/train_rrdb_P+SeD.yml")
    parser.add_argument(
        "--resume",
        type=str,
        default="pretrained/RRDB.pth",
